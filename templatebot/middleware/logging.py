...
from templatebot.logging import response_logger
...
async def bind_logger(request, handler):
    ...
    **Setting up the middleware**
    ...
    Use the `templatebot.middleware.setup_middleware` function to set this up:
    ...
    **Using the logger**
    ...
    through the `templatebot.logging.get_response_logger` function:
    ...
    `templatebot.logging.response_logger` context variable. For example:
    ...
    The ``request['logger']`` and `templatebot.logging.get_response_logger`
