...
async def render_template(
    *, template, template_variables, channel_id, user_id, logger, app
):
    ...
    rendered_filename = compute_filename(
        template=template, template_variables=template_variables, logger=logger
    )
